...
**앱의 다양한 기능**
> 이 어플을 다양한 기능을 가지고 있습니다. 크게는 **메인화면**, **중고서비스**, **고객센터**로 나누어지게 됩니다.   
> 메인화면에서는 시중에 나와있는 도서 어플처럼 누구나 손쉽게 이용할 수 있습니다.   
> 먼저 **메인화면**에서는 책 목록을 볼 수 있는 부분, 베스트 샐러 부분, 책후기 부분 공지사항 및 이벤트 부분으로 구성되었습니다.   
> **중고서비스**에서는 게시판형식으로 구성하였으며, 판매자가 책을 오리며 중고거래를 할 수 있도록 되어있습니다. 또한 다른 도서   
> 판매 앱과는 달리 판매자와 구매자는 채팅으로 쉽게 커뮤니케이션을 할 수 있도록 구현하였습니다.   
> 마지막으로 **고객센터**부분에서는 자주 묻는 질문에 대한 답변과 문의 할 수 있는 메뉴로 이루어져있습니다.   
